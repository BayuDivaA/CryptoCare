  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col w-5/6">
        ...
        {formData.title == "" || formData.bannerUrl == "" || formData.category == "" || formData.duration == 0 || formData.minimum == 0 || formData.story == "" || formData.target == 0 ? (
        ...
        <div className="flex flex-col w-full gap-2 pb-12 mt-3 text-black">
          <div className="flex md:flex-row flex-col w-full gap-2">
            <div className="flex flex-col gap-2 w-full">
              <button className="summary-grid">
                <span className="flex italic text-sm pb-2">Title</span>
                <span className="flex font-bold text-sm">{formData.title}</span>
              </button>
              <div className={"summary-grid flex justify-between" + (formData.title == "" ? "bg-red-400" : "bg-blue-400")}>
                <div className="flex-1 flex-col">
                  ...
                  <span className="flex font-bold text-sm items-center">
                    ...
                    {formData.target}
                    <span className="italic text-xs ml-2"> ( Rp.900000 )</span>
                  </span>
                </div>
            ...
            <div className="flex flex-col gap-2 w-full summary-grid">
              ...
              <img src={formData.bannerUrl} alt="banner" className="w-full" />
            </div>
          </div>
