  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col w-5/6">
        ...
        <div className="w-full md:flex-row flex-col mt-5 mb-8 rounded-md px-10 gradient-bg-verified">
          <div className="flex flex-row items-center py-2">
            ...
            <div className="flex flex-col text-white">
              ...
              <p className="md:text-xs text-sm ">You can choose the type of campaign you want according to your needs.</p>
            </div>
          </div>
        </div>
