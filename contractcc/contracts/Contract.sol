...
contract CryptoCareFactory {
    ...
    function createCampaigns(string memory _title, uint _tipes) external 
    {
        campaignCount += 1;
        ...
        Campaign newCampaigns = new Campaign(_id, _title);
...
contract Campaign {
    ...
    uint public campaignStatus; // "0-wait", "1-active", "2-reject", "3-end"
    ...
    constructor(uint _id, string memory _title) {
        campaignId = _id;
        campaignTitle = _title;
        // campaignUrl = _url;
        // campaignStory.push(_story);
        // campaignTimestamp = block.timestamp;
