...
const MyCampaignCard = ({ title, url, timestamp, collectedFunds, creator, category, donatursCount, daftar, story, active }) => {
  ...
  return (
    <>
      ...
      <div className=" w-full md:flex border border-gray-400 rounded">
        <img src={url} className="h-40  md:h-auto md:w-2/6 w-full flex-none rounded-t object-cover md:rounded-t-none md:rounded-l text-center overflow-hidden bg-white" />

        <div className="bg-white rounded-b md:rounded-b-none md:rounded-r py-2 px-4 flex flex-col justify-between leading-normal w-full">
          <div className="mb-4">
