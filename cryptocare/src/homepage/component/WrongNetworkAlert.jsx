...
import { useEthers, OptimismGoerli } from "@usedapp/core";
...
export default function WrongNetworkAlert({ isWrong, setIsWrong }) {
  ...
  const handleOnChange = async () => {
    setIsLoading(true);
    await switchNetwork(OptimismGoerli.chainId);
      ...
      <div className="bg-white rounded-md justify-center items-center py-5 px-7 max-w-sm">
        <div className="flex justify-center items-center">
          ...
          <div className="ml-3 text-sm font-medium text-red-700">
            Network does not match! Please change your network wallet to <span className="font-bold">Optimism Network!</span>
          </div>
        </div>
