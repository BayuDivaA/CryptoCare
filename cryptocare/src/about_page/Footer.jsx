...
const Footer = () => {
  return (
    <footer className="bg-neutral-200 text-center text-blue-900 dark:bg-neutral-600">
      ...
      <div className="bg-neutral-300 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
        <a className="text-neutral-800 dark:text-neutral-400" href="https://crypto-care.netlify.app">
          © 2022 Crypto Care
        </a>
      </div>
    </footer>
