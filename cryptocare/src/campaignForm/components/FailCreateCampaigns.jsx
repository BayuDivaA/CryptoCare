...
export default function FailCreate() {
        ...
        <div className="flex flex-col fixed items-center justify-center inset-0 loader-glassmorphism ">
          <div id="alert-additional-content-2" class="p-4 mb-4 text-red-900 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-900" role="alert">
            <div class="flex items-center">
              ...
              <h3 class="text-lg font-medium">Donation Failed</h3>
            </div>
            <div class="mt-2 mb-4 text-sm">Your donation failed, please try again.</div>
            <div class="flex">
